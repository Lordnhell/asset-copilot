...
const Storage = () => {
  ...
  const reports = [
    {
      id: 1,
      title: "UST 10Y 2034 Analysis",
      type: "Bond Analysis",
      date: "2024-12-01",
      quotation: "J.P. Morgan - U.S. Treasury 10Y $1M YTM 4.35%",
      status: "completed",
      size: "2.4 MB",
    },
    {
      id: 2,
      title: "SGS 10Y 2033 Quote Review",
      type: "Comparative Analysis",
      date: "2024-11-28",
      quotation: "UOB Kay Hian - Singapore Govt Bond $1M YTM 2.95%",
      status: "completed",
      size: "1.8 MB",
    },
    {
    ...
    {
      id: 5,
      title: "DRAFT: DBS 2030 Senior Bond",
      type: "Bond Analysis",
      date: "2024-11-15",
      quotation: "DBS Bank - Senior Unsecured $1M",
      status: "draft",
      size: "1.5 MB",
    },
    {
